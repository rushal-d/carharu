                            ...
                            <div class="contact-form">
                                <div class="form-group row">
                                    <div class="col-md-6 col-sm-12 required-field">
                                        ...
                                        {{ Form::text('name', null, array('class' => 'form-control', 'placeholder' => 'Title', 'data-validation' => 'required'))  }}
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        {{ Form::textarea('description', null, array('class' => 'form-control ok')) }}
                                    </div>
                                </div>
                            ...
                            <div class="card-text">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        {{ Form::select('category_ids[]', $category,null, array('required'=> 'required','multiple'=> 'multiple','id' => 'parent_id','class' => 'form-control', 'placeholder' => 'Category')) }}
                                    </div>
                                </div>
                            ...
                            <div class="card-text">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        {{ Form::hidden('featured_image', null, array('id' => 'image', 'class' => 'form-control')) }}
                                    </div>
                                </div>
                            ...
                            <div class="card-text">
                                <div class="form-group row">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        {{ Form::text('published_date_np', $date_today_np, array('readonly'=>'readonly','id' =>'published_date_np' ,'class' => 'form-control'))  }}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        {{ Form::text('published_date',  date('Y-m-d'), array('id' =>'published_date' ,'class' => 'form-control'))  }}
                                    </div>
                                </div>
...
{{--                                </div>--}}
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        {{ Form::number('sort_order', null, array('min' => 0, 'class' => 'form-control'))  }}
                                    </div>
                                </div>
                            </div>
                        </div>
