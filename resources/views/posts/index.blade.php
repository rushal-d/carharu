                            ...
                            <div class="filter">
                                <div class="row form-group">
                                    ...
                                    <div class="filter custom-filter-bar do-not-display-filter-bar-for-small-device col-md-12">
                                        {!! Form::open(['route' => 'posts.index', 'method' => 'GET', 'id' => 'department-form']) !!}
                                        <div class="row">
                                    ...
                                    @if(!empty($posts) && count($posts)>0)
                                        @foreach($posts as $post)
                                            <tr>
                                                ...
                                                <td>
                                                    {{\Carbon\Carbon::parse($post->published_date)->format('Y-m-d')}}
                                                </td>
                                                <td>
                                                    <a href="{{route('posts.edit', ['id' => $post->id])}}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
