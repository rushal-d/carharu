...
@section('content')
    ...
    <section class="padding-block block">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="filter">
                                <div class="row form-group">
                                    ...
                                    <div
                                        ...
                                        {!! Form::open(['route' => 'frontend.compare', 'method' => 'GET', 'id' => 'form']) !!}
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row clone">
            ...
            <div class="row mt-2" id="appended-view">
...
@section('scripts')
    <script>
        ...
        $('#compare').click(function (e) {
            ...
            $.ajax(({
                url:'{!! route("compareByAjaxFrontend", $_GET) !!}',
                type: 'get',
                data: {
                    '_token':'{{csrf_token()}}',
                    modelIds: modelIds
        ...
        $(document).on("change", '.brand', function () {
            ...
            $.ajax({
                url: '{{route('ajax-get-models-by-brand-id-frontend')}}',
                type: 'GET',
                data:{
                    brand_id: $_this.val(),
                },
