                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header level">
                            <h3 class="flex">Specifications</h3>
                        </div>
                        <div class="card-body">
                            <!-- filter -->
                            <div class="filter">
                                <div class="row form-group">
                                    <div class="col-lg-12">
                                        <div class="add-new mb-3">
                                            <a href="{{route('specs.create')}}" class="btn btn-success">
                                    ...
                                    <div class="filter custom-filter-bar do-not-display-filter-bar-for-small-device col-md-12">
                                        {!! Form::open(['route' => 'specs.index', 'method' => 'GET', 'id' => 'department-form']) !!}
                                        <div class="row">
                            ...
                            <div class="table-responsive col-lg-8" id="tableid">
                                <table class="table table-striped table-hover department-table">
                                    ...
                                    @forelse($specs as $spec)
                                        <tr>
                                            <th scope="row">{{ ($specs->currentpage()-1) * $specs->perpage() + $loop->index + 1 }}</th>
                                            <td>
                                                {{$spec->specification}}
                                            </td>
                                            <td>
                                                <a href="{{route('specs.destroy', $spec->id)}}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                ...
                                <div class="text-center">{{$specs->links()}}</div>
                            </div>
                        </div>
                    </div>
                </div>
